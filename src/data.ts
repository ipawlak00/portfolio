...
export const projectsData: ProjectItem[] = [
  ...
  },
  {
    ...
    text: "Rola pomostu między biznesem, deweloperami i użytkownikami. Przeprowadziłam całościowy redesign złożonego harmonogramowania widocznego dla setek pracowników.<br><br><b>Kompetencje (Product Owner / Process &amp; Operations):</b><ul class='timeline-list'><li><b>Product Discovery i User Research:</b> zbieranie feedbacku operacyjnego od użytkowników, by trafnie zdefiniować problem i potrzeby.</li><li><b>Prototypowanie i makiety:</b> klikalne prototypy (Figma, Miro) testowane z użytkownikami zanim powstanie docelowy kod.</li><li><b>Stakeholder management:</b> walidacja makiet z zarządem z wyprzedzeniem — budowanie dokładnie tego, czego potrzebują interesariusze.</li></ul>",
